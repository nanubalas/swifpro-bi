...
NAV = [
    ...
    ("Reports", [
        ("All Reports", "/reports/", "bar-chart-line", {ADMIN, ACCOUNTANT, FINANCE, MANAGER, READONLY}),
        ...
        ("Stock Valuation", "/reports/stock-valuation/", "box-seam", {ADMIN, ACCOUNTANT, MANAGER, WAREHOUSE, READONLY}),
