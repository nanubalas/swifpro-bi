...
NAV = [
    ...
    ("Sales", [
        ...
        ("Channel Orders (Experimental)", "/sales-orders/", "bag", {ADMIN, MANAGER, SALES}),
    ...
    ("Inventory", [
        ...
        ("Bins (Advisory)", "/bins/", "grid-3x3-gap", {ADMIN, MANAGER, WAREHOUSE}),
    ...
    ("Planning", [
        ("Planner Dashboard", "/mrp/dashboard/", "speedometer2", {ADMIN, MANAGER, PURCHASING, WAREHOUSE}),
        ("MRP Setup Guide", "/mrp/setup-guide/", "signpost-2", {ADMIN, MANAGER, PURCHASING, WAREHOUSE}),
        ("MRP Health Check", "/mrp/health-check/", "heart-pulse", {ADMIN, MANAGER, PURCHASING, WAREHOUSE}),
        ...
        ("Saved Views", "/mrp/saved-views/", "bookmarks", {ADMIN, MANAGER, WAREHOUSE, PURCHASING}),
        ("Scheduled Exports", "/mrp/scheduled-exports/", "envelope-paper", {ADMIN, MANAGER, PURCHASING}),
    ]),
    ("Finance", [
...
NAV_META = {
    ...
    "/sales-orders/": {"desc": "Experimental: manual channel-order posting tool (not connected to Shopify/Amazon sync).", "keywords": ["channel", "marketplace", "ecommerce", "shopify", "amazon", "experimental"]},
    ...
    "/mrp/dashboard/": {"desc": "Planner dashboard: MRP KPIs, exceptions, suggestions and run comparison.", "keywords": ["dashboard", "planner", "kpi", "overview", "metrics", "comparison", "summary"]},
    "/mrp/setup-guide/": {"desc": "Step-by-step MRP setup guide with completion status.", "keywords": ["setup", "guide", "getting started", "onboarding", "steps", "how to", "mrp setup"]},
    "/mrp/health-check/": {"desc": "MRP setup readiness diagnostics and common-issue checks.", "keywords": ["health", "health check", "diagnostics", "readiness", "validation", "missing supplier", "missing bom", "qa"]},
    "/mrp/saved-views/": {"desc": "Saved report and workbench filter views.", "keywords": ["saved view", "saved views", "filter", "report view", "bookmark", "preset"]},
    "/mrp/scheduled-exports/": {"desc": "Scheduled MRP report exports by email.", "keywords": ["scheduled", "export", "email", "report schedule", "csv", "xlsx", "recurring"]},
    ...
    "/bins/": {"desc": "Advisory bin sub-locations within a location (not yet bin-aware for receiving/picking/transfers/ATP).", "keywords": ["bin", "bin balance", "shelf", "aisle", "advisory"]},
