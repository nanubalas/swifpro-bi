...
MANAGE_MRP_REPORTS = "manage_mrp_reports"
VIEW_PLANNING_DASHBOARD = "view_planning_dashboard"
MANAGE_SCHEDULED_EXPORTS = "manage_scheduled_exports"
...
PERMISSIONS = [
    ...
    (MANAGE_MRP_REPORTS, "Manage shared saved report views", "Planning"),
    (VIEW_PLANNING_DASHBOARD, "View the planner dashboard", "Planning"),
    (MANAGE_SCHEDULED_EXPORTS, "Manage scheduled report exports", "Planning"),
]
...
ROLE_PERMISSIONS = {
    ...
    roles.MANAGER: {
        ...
        MANAGE_MRP_REPORTS, VIEW_PLANNING_DASHBOARD, MANAGE_SCHEDULED_EXPORTS,
    },
    ...
    roles.WAREHOUSE: {VIEW_DASHBOARD, MANAGE_INVENTORY, MANAGE_PRODUCTS, VIEW_MRP,
                      ...
                      VIEW_MRP_REPORTS, VIEW_MRP_SUGGESTIONS, VIEW_PLANNING_DASHBOARD},
