...
urlpatterns = [
    ...
    path("po/<int:po_id>/view/", views.po_document_view, name="po_document_view"),
    ...
    path("customer-orders/<int:order_id>/view/", views.corder_document_view, name="corder_document_view"),
...
path("invoices/<int:invoice_id>/post/", views.invoice_post, name="invoice_post"),
    ...
    path("reports/near-expiry/", views.report_near_expiry, name="report_near_expiry"),
    path("reports/lot-trace/", views.report_lot_trace, name="report_lot_trace"),
    ...
    path("mrp/runs/<int:run_id>/workbench/", views.mrp_workbench, name="mrp_workbench"),
    path("mrp/runs/<int:run_id>/bulk/", views.mrp_bulk_action, name="mrp_bulk_action"),
